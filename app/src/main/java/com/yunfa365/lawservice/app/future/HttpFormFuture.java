 ...
 */
public class HttpFormFuture extends AgnettyFuture {
    private HttpFormHandler mHandler;
    //下载地址
    private String mUrl;
    //连接超时时间
    ...
    public HttpFormFuture(Context context) {
        super(context);
    ...
    public void run() {
        ...
        if(mHandler == null) {
            ...
            if(mHandlerCls == null) {
                mHandler = new HttpFormDefaultHandler(mContext);
            } else {
                try {
                    Constructor<? extends AgnettyHandler> constructor
                            = mHandlerCls.getConstructor(Context.class);
                    mHandler = (HttpFormHandler)constructor.newInstance(mContext);
                } catch (Exception ex) {
    ...
    public String getName() {
        String futureName = mHandlerCls==null ? HttpFormDefaultHandler.class.getName() : mHandlerCls.getName();
        return futureName;
    }
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setHandler(Class<? extends HttpFormHandler> handler) {
         ...
         * @return
         */
        public HttpFormFuture create() {
            final HttpFormFuture future = new HttpFormFuture(mContext);
         ...
         * @return
         */
        public HttpFormFuture execute() {
            HttpFormFuture future = create();
            future.execute();
            return future;
        }
    }
