...
public class CustomMenuRightFragment extends Fragment {
    ...
    private CustomListActivity mActivity;

    @AfterViews
    void init(){
        mActivity = (CustomListActivity) getActivity();
    ...
    void button1OnClick(View view) {
        ...
        String keyword2 = ((TSearchType)jsfs.getTag()).id + "";
        mActivity.reSearch(keyword1, keyword2);
    }
