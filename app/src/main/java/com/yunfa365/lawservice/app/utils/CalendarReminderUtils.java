...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "elvshi";
    private static String CALENDARS_ACCOUNT_NAME = "calendar@elvshi.cn";
    private static String CALENDARS_ACCOUNT_TYPE = CalendarContract.ACCOUNT_TYPE_LOCAL; //"com.elvshi.cn";  // CalendarContract.ACCOUNT_TYPE_LOCAL
    private static String CALENDARS_DISPLAY_NAME = "E律师日历";
    ...
    public static void addCalendarEvent(Context context, String title, String description, long reminderTime, int previousDate) {
        ...
        mCalendar.setTimeInMillis(start + 120 * 60 * 1000);//设置终止时间，开始时间加10分钟
